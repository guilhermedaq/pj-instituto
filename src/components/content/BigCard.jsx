...
function BigCard(){
    return (
        <div className="flex flex-col items-center md:flex-row md:justify-center lg:items-stretch  gap-5">
            {/* primeiro card prinicipal */}
            <div className="shadow-2xl bg-[#F9F6EE] rounded-xl  sm:w-96 transition-transform duration-300 ease-in hover:scale-105 cursor-pointer">
                <img src={OncaJpg} className="rounded-t" alt="" />
                <div className="flex flex-col items-center font-serif px-1 py-1">
                    <h1 className="font-bold text-2xl">Situação atual </h1>
            ...
            <div className="shadow-2xl bg-[#F9F6EE] rounded-xl  sm:w-96 transition-transform duration-300 ease-in hover:scale-105 cursor-pointer">
                <img src={pantanalcapa} alt="foto" className="rounded-t h-65" />
                <div className="flex flex-col items-center font-serif px-1 py-1"> 
                    <h1 className="font-bold text-2xl">Importância ambiental</h1>
